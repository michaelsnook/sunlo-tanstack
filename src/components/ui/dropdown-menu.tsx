...
>(({ className, inset, children, ...props }, ref) => (
	<DropdownMenuPrimitive.SubTrigger
		ref={ref}
		className={cn(
			'flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden focus:bg-violet-100 data-[state=open]:bg-violet-100 dark:focus:bg-violet-800 dark:data-[state=open]:bg-violet-800',
			inset && 'pl-8',
			className
		)}
		{...props}
...
>(({ className, inset, ...props }, ref) => (
	<DropdownMenuPrimitive.Item
		ref={ref}
		className={cn(
			'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden transition-colors focus:bg-violet-100 focus:text-violet-900 data-disabled:pointer-events-none data-disabled:opacity-50 dark:focus:bg-violet-800 dark:focus:text-violet-50',
			inset && 'pl-8',
			className
		)}
		{...props}
...
>(({ className, children, checked, ...props }, ref) => (
	<DropdownMenuPrimitive.CheckboxItem
		ref={ref}
		className={cn(
			'relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-hidden transition-colors focus:bg-violet-100 focus:text-violet-900 data-disabled:pointer-events-none data-disabled:opacity-50 dark:focus:bg-violet-800 dark:focus:text-violet-50',
			className
		)}
		checked={checked}
		{...props}
